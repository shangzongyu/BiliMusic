...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  recordPlayHistory: (track) => ipcRenderer.invoke('history:record', track),
  getPlayHistoryStats: () => ipcRenderer.invoke('history:stats'),
  clearPlayHistory: () => ipcRenderer.invoke('history:clear'),
